    ...
    capabilities: [
      {
        ...
        items: [
          "Cloud-based or on-premise phone systems engineered toward a carrier-grade 99.99% uptime target",
      ...
      },
      {
        ...
        items: [
          "Click-to-Call – Initiate calls directly from your CRM customer record with one click",
      ...
      },
      {
        ...
        items: [
          ...
          "AI speech analytics delivering real-time sentiment scoring, keyword flagging, and agent coaching",
  ...
  },
  {
    ...
    capabilities: [
      ...
      },
      {
        ...
        items: [
          "Scalable architecture supporting 250+ distinct zones per facility or distributed enterprise",
...
export const INDUSTRIES_DATA: IndustryUseCase[] = [
  ...
  },
  {
    ...
    icon: "Factory",
    description: "Industrial complexes requiring ruggedized surveillance, high-output plant audio, and mission-critical voice communications.",
