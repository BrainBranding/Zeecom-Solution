  ...
  useEffect(() => {
    applyPageSeo({
      ...
      structuredData: {
        ...
        url: 'https://zeecomsolution.com/terms-and-conditions',
        isPartOf: { '@id': 'https://zeecomsolution.com/#website' },
        breadcrumb: {
          '@type': 'BreadcrumbList',
          itemListElement: [
            { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://zeecomsolution.com/' },
            { '@type': 'ListItem', position: 2, name: 'Terms and Conditions', item: 'https://zeecomsolution.com/terms-and-conditions' },
          ],
        },
      },
    });
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-cyan-500/30 selection:text-cyan-200">
      ...
      <header className="sticky top-0 z-40 w-full bg-slate-950/90 backdrop-blur-md border-b border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 min-h-20 py-3 flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex flex-1 sm:flex-none items-center justify-end gap-2 sm:gap-4 min-w-0">
            <a
              href="/"
            ...
            >
              ...
              <span className="hidden xs:inline">Back to Home</span><span className="xs:hidden">Home</span>
            </a>
            <button
              type="button"
            ...
            >
              <span className="hidden sm:inline">Schedule Consultation</span><span className="sm:hidden">Consult</span>
            </button>
          </div>
        </div>
      </header>
