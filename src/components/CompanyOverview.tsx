...
export const CompanyOverview: React.FC<CompanyOverviewProps> = ({ onNavigate }) => {
  ...
  return (
    <section id="overview" className="py-20 bg-slate-900/50 text-slate-100 border-t border-slate-800 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-8 rounded-2xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800 hover:border-cyan-500/40 transition-all shadow-xl">
          ...
          <div className="p-8 rounded-2xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800 hover:border-blue-500/40 transition-all shadow-xl">
            <div className="flex items-center gap-3 mb-4">
        ...
        <div className="mt-16 p-6 sm:p-8 rounded-2xl bg-slate-950 border border-slate-800 shadow-xl">
          <div className="flex flex-wrap items-center justify-between gap-4 pb-6 border-b border-slate-800">
            <div className="flex items-center gap-4">
              <BrandLogo size="lg" tagline={false} />
              ...
              <div>
                ...
                <h3 className="text-xl font-bold text-white">Principal Engineering Office</h3>
              </div>
            </div>
          ...
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-xs">
            ...
            <div className="p-4 rounded-xl bg-slate-900/60 border border-slate-800">
              ...
              <a
                ...
                className="text-base font-mono font-bold text-emerald-400 hover:text-emerald-300 block"
              >
                {COMPANY_INFO.phone}
              </a>
              <p className="text-[11px] text-slate-400 mt-1">
            ...
            <div className="p-4 rounded-xl bg-slate-900/60 border border-slate-800">
              ...
              <a
                ...
                className="text-base font-bold text-cyan-400 hover:text-cyan-300 block"
              >
            ...
            <div className="p-4 rounded-xl bg-slate-900/60 border border-slate-800">
              ...
              <a
                ...
                className="text-sm font-semibold text-purple-300 hover:text-white block"
              >
                {COMPANY_INFO.email}
              </a>
              <p className="text-[11px] text-slate-400 mt-1">
        ...
        <div className="mt-16 p-8 sm:p-10 rounded-2xl bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 border border-cyan-500/30 relative overflow-hidden">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
            <div className="lg:col-span-2">
              ...
              <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-slate-300">
                <div className="flex items-center gap-2">
            ...
            <div className="bg-slate-900/90 p-6 rounded-xl border border-slate-800 flex flex-col justify-center text-center">
              ...
              <button
                ...
                className="w-full py-2.5 px-4 rounded-lg bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-bold text-xs transition-colors flex items-center justify-center gap-1.5"
              >
