...
export const HeroSection: React.FC<HeroSectionProps> = ({ onNavigate, onOpenConsultation }) => {
  return (
    <section id="hero" className="relative overflow-hidden pt-10 pb-16 sm:pt-16 sm:pb-24 lg:pt-20 lg:pb-28 bg-slate-950 text-white">
      {/* Subtle Background Glow Elements */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] sm:w-[700px] h-[250px] sm:h-[350px] bg-gradient-to-tr from-cyan-600/15 via-blue-600/10 to-purple-600/15 blur-[100px] sm:blur-[120px] pointer-events-none rounded-full" />
      <div className="absolute -top-10 -right-10 w-72 sm:w-96 h-72 sm:h-96 bg-cyan-500/10 rounded-full blur-[80px] sm:blur-[100px] pointer-events-none" />
      <div className="absolute -bottom-10 -left-10 w-72 sm:w-96 h-72 sm:h-96 bg-blue-600/10 rounded-full blur-[80px] sm:blur-[100px] pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center justify-center gap-3 text-center">
          ...
          <div className="inline-flex flex-wrap items-center justify-center gap-1.5 sm:gap-2 px-3.5 py-1.5 rounded-full bg-slate-900/90 border border-cyan-500/30 text-cyan-300 text-xs font-semibold shadow-inner shadow-cyan-500/10 max-w-full">
            <span className="w-2 h-2 rounded-full bg-cyan-400 animate-ping shrink-0" />
            <span className="truncate">Next-Generation Intelligent Enterprise Systems</span>
            <span className="text-slate-500 hidden sm:inline">|</span>
            <span className="text-slate-300 hidden md:inline">Bridging Physical & Digital Infrastructure</span>
          </div>
        </div>
        ...
        <div className="mt-6 text-center max-w-4xl mx-auto">
          ...
          <p className="mt-5 sm:mt-6 text-base sm:text-lg lg:text-xl text-slate-300 font-normal leading-relaxed max-w-3xl mx-auto">
        ...
        {/* Action Buttons - Stack vertically on mobile below 640px/768px with min 44px touch height */}
        <div className="mt-8 flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 sm:gap-4 max-w-lg sm:max-w-none mx-auto">
          <button
            ...
            className="min-h-[48px] px-6 py-3.5 rounded-xl font-semibold bg-gradient-to-r from-cyan-500 via-cyan-400 to-blue-500 hover:from-cyan-400 hover:to-blue-400 text-slate-950 shadow-xl shadow-cyan-500/20 transition-all transform hover:-translate-y-0.5 active:translate-y-0 flex items-center justify-center gap-2.5 focus:outline-none focus:ring-2 focus:ring-cyan-400"
          >
          ...
          <button
            ...
            className="min-h-[48px] px-6 py-3.5 rounded-xl font-semibold bg-slate-900 hover:bg-slate-850 text-white border border-slate-700 hover:border-cyan-500/50 shadow-lg transition-all flex items-center justify-center gap-2 focus:outline-none focus:ring-2 focus:ring-cyan-400"
          >
          ...
          <button
            ...
            className="min-h-[48px] px-5 py-3.5 rounded-xl font-medium text-slate-300 hover:text-white bg-slate-900/60 sm:bg-transparent hover:bg-slate-900/60 transition-colors flex items-center justify-center gap-1.5 focus:outline-none focus:ring-2 focus:ring-cyan-400"
          >
        ...
        {/* 3 Core Domain Highlight Cards (Single column on mobile, 3 columns on tablet/desktop) */}
        <div className="mt-12 sm:mt-14">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <button
              ...
              className="text-left group relative p-6 rounded-2xl bg-gradient-to-b from-slate-900/90 to-slate-950/90 border border-slate-800 hover:border-blue-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/10 cursor-pointer flex flex-col justify-between focus:outline-none focus:ring-2 focus:ring-blue-400 min-h-[44px]"
            >
              <div>
              ...
              <div className="mt-6 pt-4 border-t border-slate-800/80 flex items-center justify-between text-xs sm:text-sm text-blue-400 font-semibold">
            ...
            <button
              ...
              className="text-left group relative p-6 rounded-2xl bg-gradient-to-b from-slate-900/90 to-slate-950/90 border border-slate-800 hover:border-emerald-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-emerald-500/10 cursor-pointer flex flex-col justify-between focus:outline-none focus:ring-2 focus:ring-emerald-400 min-h-[44px]"
            >
              <div>
                <div className="flex items-center justify-between mb-4">
                ...
                <p className="mt-2.5 text-sm sm:text-base text-slate-300 leading-relaxed">
                  Resilient telephony, instant CRM screen pops, one-click dialing, omnichannel messaging, and AI speech analytics.
                </p>
              </div>
              <div className="mt-6 pt-4 border-t border-slate-800/80 flex items-center justify-between text-xs sm:text-sm text-emerald-400 font-semibold">
                <span className="flex items-center gap-1.5">
            ...
            <button
              ...
              className="text-left group relative p-6 rounded-2xl bg-gradient-to-b from-slate-900/90 to-slate-950/90 border border-slate-800 hover:border-amber-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-amber-500/10 cursor-pointer flex flex-col justify-between focus:outline-none focus:ring-2 focus:ring-amber-400 min-h-[44px]"
            >
              <div>
                <div className="flex items-center justify-between mb-4">
              ...
              <div className="mt-6 pt-4 border-t border-slate-800/80 flex items-center justify-between text-xs sm:text-sm text-amber-400 font-semibold">
                <span className="flex items-center gap-1.5">
        ...
        <div className="mt-12 sm:mt-14 p-5 sm:p-6 rounded-2xl bg-slate-900/60 border border-slate-800 backdrop-blur-md">
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-6 text-center">
            {COMPANY_INFO.stats.map((stat, idx) => (
              <div key={idx} className="flex flex-col items-center">
                ...
                <span className="text-xs sm:text-sm font-semibold text-slate-200 mt-1">{stat.label}</span>
          ...
          <p className="mt-4 text-center text-xs text-slate-400 leading-relaxed">
            Illustrative engineering benchmarks and supported hardware specifications; final performance is validated during site assessment and documented in the project proposal.
          </p>
        </div>
      </div>
    </section>
