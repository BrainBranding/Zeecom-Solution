...
export const SolutionVoIP: React.FC<SolutionVoIPProps> = ({ onOpenConsultation }) => {
  ...
  return (
    <section id="voip-crm" className="py-14 sm:py-18 bg-slate-900/40 text-slate-100 border-t border-slate-800 relative overflow-hidden">
      {/* Background glow */}
                ...
                <div className={`mt-4 p-4 rounded-xl text-center border transition-all ${
                  ...
                  {callState === 'IDLE' && (
                    <div className="py-2">
                      ...
                      <div className="text-xs text-emerald-300 font-medium mt-1">Select any CRM contact for one-click dialing</div>
                    </div>
                  )}
                </div>
                  ...
                  <div className="mt-4 space-y-4">
                    ...
                    <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800 flex flex-wrap items-center justify-between gap-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-[11px] sm:text-xs px-2 py-0.5 rounded-full bg-emerald-500/20 text-emerald-300 border border-emerald-500/30 font-semibold">
                              {activeCustomer.status}
                            </span>
                          </div>
                          <p className="text-xs sm:text-sm text-slate-300">{activeCustomer.company} • {activeCustomer.tier}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          aria-label={`Initiate one-click call to ${activeCustomer.name} at ${activeCustomer.phone}`}
                          className="min-h-[44px] px-3.5 py-2 rounded-xl bg-emerald-500/20 hover:bg-emerald-500/30 text-emerald-300 border border-emerald-500/40 text-xs sm:text-sm font-semibold flex items-center gap-1.5"
                        >
                          <Phone className="w-3.5 h-3.5" />
                          <span>One-Click Call: {activeCustomer.phone}</span>
                        </button>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 sm:gap-3 text-xs">
                      <div className="p-3 rounded-lg bg-slate-900/60 border border-slate-800">
                        <span className="text-slate-400 block font-medium text-[11px] sm:text-xs">Account Lead</span>
                        <span className="text-white font-semibold text-xs sm:text-sm">{activeCustomer.accountManager}</span>
                      </div>
                      <div className="p-3 rounded-lg bg-slate-900/60 border border-slate-800">
                        <span className="text-slate-400 block font-medium text-[11px] sm:text-xs">Open Tickets</span>
                        <span className="text-emerald-400 font-semibold text-xs sm:text-sm">{activeCustomer.openTickets} Priority</span>
                      </div>
                      <div className="p-3 rounded-lg bg-slate-900/60 border border-slate-800">
                        <span className="text-slate-400 block font-medium text-[11px] sm:text-xs">Last Touch</span>
                        <span className="text-white font-semibold truncate block text-xs sm:text-sm">{activeCustomer.lastInteraction}</span>
                      </div>
                      <div className="p-3 rounded-lg bg-slate-900/60 border border-slate-800">
                        <span className="text-slate-400 block font-medium text-[11px] sm:text-xs">Email Sync</span>
                ...
                {activeTab === 'omnichannel' && (
                  <div className="mt-4 p-4 rounded-xl bg-slate-900/80 border border-slate-800 space-y-3">
                    <div className="flex items-center justify-between pb-2 border-b border-slate-800">
                      <span className="text-xs sm:text-sm font-bold text-white">Unified Omnichannel Thread</span>
                      <span className="text-[11px] sm:text-xs px-2 py-0.5 rounded bg-emerald-500/20 text-emerald-300">WhatsApp & 2-Way SMS Synced</span>
                    </div>
                  ...
                  <div className="mt-4 p-4 rounded-xl bg-slate-900/80 border border-slate-800 space-y-4">
                    <div className="flex items-center justify-between pb-2 border-b border-slate-800">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs sm:text-sm font-bold text-white">Real-Time AI Conversation Insights</span>
                      </div>
                      <span className="text-[11px] sm:text-xs px-2 py-0.5 rounded bg-purple-500/20 text-purple-300 font-mono">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs sm:text-sm">
                      <div className="p-3 rounded-lg bg-slate-950 border border-slate-800">
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          <span className="px-2 py-0.5 rounded bg-slate-900 text-cyan-300 border border-slate-700 text-[11px] sm:text-xs">PoE Power Budget</span>
                          <span className="px-2 py-0.5 rounded bg-slate-900 text-emerald-300 border border-slate-700 text-[11px] sm:text-xs">123dB Horn Speakers</span>
                          <span className="px-2 py-0.5 rounded bg-slate-900 text-purple-300 border border-slate-700 text-[11px] sm:text-xs">99.99% Uptime SLA</span>
                        </div>
                      </div>
                      <div className="p-3 rounded-lg bg-slate-950 border border-slate-800">
