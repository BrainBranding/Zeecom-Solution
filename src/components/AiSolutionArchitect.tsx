...
===============================================
  ...
  return (
    <section id="ai-architect" className="py-14 sm:py-18 bg-slate-900/60 text-slate-100 border-t border-slate-800 relative overflow-hidden">
      {/* Glow background */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8">
          ...
          <div aria-live="polite" aria-busy={isLoading} className="lg:col-span-7 p-5 sm:p-6 rounded-2xl bg-slate-950 border border-slate-800 shadow-xl flex flex-col justify-between">
            {recommendation ? (
