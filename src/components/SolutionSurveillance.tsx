...
export const SolutionSurveillance: React.FC<SolutionSurveillanceProps> = ({ onOpenConsultation }) => {
  ...
  return (
    <section id="ai-surveillance" className="py-20 bg-slate-950 text-slate-100 border-t border-slate-800 relative overflow-hidden">
      {/* Background glow */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* ========================================================================= */}
        <div className="mt-16 p-6 sm:p-8 rounded-2xl bg-gradient-to-b from-slate-900 via-slate-950 to-slate-950 border border-blue-500/30 shadow-2xl">
          <div className="flex flex-wrap items-center justify-between gap-4 pb-6 border-b border-slate-800">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              >
                ...
                <span>AI Vision Boxes: {showAiBoxes ? 'ON' : 'OFF'}</span>
              </button>
          ...
          {lockdownActive && (
            <div className="mt-4 p-3 rounded-xl bg-red-950/80 border border-red-600 text-red-200 text-xs font-bold flex items-center justify-between animate-pulse">
              ...
              <span className="px-2 py-0.5 rounded bg-red-800 text-white text-[10px]">CODE RED</span>
            </div>
          )}
          ...
          <div className="mt-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              <div className="relative aspect-video rounded-xl bg-slate-950 border border-slate-800 overflow-hidden shadow-inner flex flex-col justify-between p-4">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="relative w-4/5 h-4/5 border border-cyan-500/10 rounded-lg flex items-center justify-center">
                      <div className="w-1/2 h-1/2 border border-cyan-500/20 rounded-md flex items-center justify-center">
                        <Camera className="w-12 h-12 text-slate-700/50" />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                {showAiBoxes && (
                  <div className="relative z-10 my-auto grid grid-cols-2 gap-6 p-4">
                    {/* Bounding Box 1: Verified Face */}
                    <div className="relative p-3 rounded-lg border-2 border-emerald-400/80 bg-emerald-950/20 backdrop-blur-xs w-48 shadow-lg shadow-emerald-500/10">
                    ...
                    {selectedCam.id === 'CAM-03' || anomalySimulated ? (
                      <div className="relative p-3 rounded-lg border-2 border-amber-400/90 bg-amber-950/30 backdrop-blur-xs w-52 shadow-lg shadow-amber-500/20 ml-auto animate-pulse">
                      ...
                      <div className="relative p-3 rounded-lg border border-cyan-400/60 bg-cyan-950/20 backdrop-blur-xs w-44 ml-auto">
                        ...
                        <div className="text-[11px] text-cyan-200 mt-1">Authorized Path Normal</div>
                      </div>
                    )}
                  </div>
                )}
            ...
            <div className="p-4 rounded-xl bg-slate-950 border border-slate-800 flex flex-col justify-between">
              ...
              <div className="mt-4 pt-3 border-t border-slate-800 text-[11px] text-slate-400">
                ...
                <span>Supports touchless face, fingerprint, mobile NFC, & encrypted QR credential tokens.</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-14 grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="p-6 rounded-2xl bg-slate-900/50 border border-slate-800 flex flex-col justify-between">
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                {data.idealFor.map((item, i) => (
                  <div key={i} className="p-2.5 rounded-lg bg-slate-950 border border-slate-800/80 text-xs font-medium text-slate-300 flex items-center gap-2">
            ...
            <div className="mt-6 pt-4 border-t border-slate-800 flex items-center justify-between">
              <span className="text-xs text-slate-400">Ready to modernize your physical security?</span>
              <button
                onClick={onOpenConsultation}
                className="px-4 py-2 rounded-xl bg-blue-500 hover:bg-blue-400 text-slate-950 font-bold text-xs transition-colors shadow-lg shadow-blue-500/20"
              >
