              ...
              {solutionsDropdownOpen && (
                ...
                >
                  <a
                    ...
                    onClick={(e) => { e.preventDefault(); handleNav('ai-surveillance'); }}
                    role="menuitem"
                  ...
                  <a
                    href="#voip-crm"
                    onClick={(e) => { e.preventDefault(); handleNav('voip-crm'); }}
                    role="menuitem"
                  ...
                  <a
                    href="#ip-audio"
                    onClick={(e) => { e.preventDefault(); handleNav('ip-audio'); }}
                    role="menuitem"
                    className="w-full text-left px-4 py-3 hover:bg-slate-800/80 transition-colors flex items-start gap-3 group border-t border-slate-800/60"
                  >
        ...
        <div className="lg:hidden bg-slate-950/98 border-b border-slate-800 px-4 pt-3 pb-8 space-y-2.5 max-h-[calc(100vh-5rem)] overflow-y-auto shadow-2xl">
          ...
          >
            ...
            <div className="flex-1">
              ...
              <div className="text-xs text-slate-400">99.99% Target, Screen-Pops &amp; AI Speech</div>
            </div>
          </a>
